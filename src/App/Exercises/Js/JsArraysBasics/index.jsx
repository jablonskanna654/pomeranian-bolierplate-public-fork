...
const Exercise = () => {
  ...
  }; // Podlicz punkty dla drużyny  const teamScore = removeDuplicateID(removeCheaters(team)).reduce(    (accumulator, currentValue) => accumulator + currentValue.userScore,    0  );  return <>Your team scored {teamScore} points</>;};export default Exercise;
